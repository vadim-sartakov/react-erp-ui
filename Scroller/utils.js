...
export var getOverscrolledCoordinateOffset = function getOverscrolledCoordinateOffset(_ref10) {
  var coordinate = _ref10.coordinate,
      containerSize = _ref10.containerSize,
      fixedSize = _ref10.fixedSize;
...
export var getOverscrolledCellOffset = function getOverscrolledCellOffset(_ref11) {
  var rows = _ref11.rows,
      columns = _ref11.columns,
      defaultRowHeight = _ref11.defaultRowHeight,
      defaultColumnWidth = _ref11.defaultColumnWidth,
      rowIndex = _ref11.rowIndex,
      columnIndex = _ref11.columnIndex,
      fixRows = _ref11.fixRows,
      fixColumns = _ref11.fixColumns,
      scrollTop = _ref11.scrollTop,
      scrollLeft = _ref11.scrollLeft,
      containerWidth = _ref11.containerWidth,
      containerHeight = _ref11.containerHeight;
  var x = getCellPosition({
    meta: columns,
    index: columnIndex,
    defaultSize: defaultColumnWidth
  });
  var y = getCellPosition({
    meta: rows,
    index: rowIndex,
    defaultSize: defaultRowHeight
  });
  var relativeX = x - scrollLeft;
  var relativeY = y - scrollTop;
  var fixedRowsSize = getCellsRangeSize({
    startIndex: 0,
    meta: rows,
    count: fixRows,
    defaultSize: defaultRowHeight
  });
  var fixedColumnsSize = getCellsRangeSize({
    startIndex: 0,
    meta: columns,
    count: fixColumns,
    defaultSize: defaultColumnWidth
  });
  var height = rows && rows[rowIndex] && rows[rowIndex].size || defaultRowHeight;
  var width = columns && columns[columnIndex] && columns[columnIndex].size || defaultColumnWidth;
  if (y + height >= y && relativeY > fixedRowsSize) y += height;
  if (x + width >= x && relativeX > fixedColumnsSize) x += width;
  x -= scrollLeft;
  y -= scrollTop;
  var overscrollLeft = getOverscrolledCoordinateOffset({
    coordinate: x,
    containerSize: containerWidth,
    fixedSize: fixedColumnsSize
  });
  var overscrollTop = getOverscrolledCoordinateOffset({
    coordinate: y,
    containerSize: containerHeight,
    fixedSize: fixedRowsSize
  });
  return {
