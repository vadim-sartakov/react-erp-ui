...
import { getVisiblePages, getItemsCountOnPage, getPageNumber, getGaps, getFixedOffsets, getScrollPages, getItemsSize, getOverscrolledCellOffset } from './utils';
/**
...
var useScroller = function useScroller(_ref) {
  ...
  useEffect(function () {
    if (focusedCell && scrollerContainerRef.current) {
      var containerRect = scrollerContainerRef.current.getBoundingClientRect();
